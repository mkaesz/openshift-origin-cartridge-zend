 ...
 * @nodep Gtk
 */
if ('/var/lib/openshift/52914f2e5973cac9cd000053/zend/php-5.5/share/pear' != '@'.'include_path'.'@') {
    ini_set('include_path', '/var/lib/openshift/52914f2e5973cac9cd000053/zend/php-5.5/share/pear');
    $raw = false;
} else {
