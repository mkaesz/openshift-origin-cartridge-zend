...
class ZendServerGateway
{
    ...
    /**
     * @var Framework\ControllerAbstractFactory
     */
    ...
    public function __construct(Application $application)
    {
        ...
        $this->controllerAbstractFactory = new Framework\ControllerAbstractFactory();

        $this->controllerManager = $sm->get('ControllerLoader');
        $this->controllerManager->addAbstractFactory($this->controllerAbstractFactory);
    }

    public function configure($gatewayXmlFile)
    {
        $xmlReader = new XmlConfig();
        $this->config = $xmlReader->fromFile($gatewayXmlFile);
    ...
    public function route($url, $dispatchable, $methods = 'GET', $validation = null, $response = null, $authenticate = null)
    {
        ...
        $routeName = 'gateway-route-' . $routeCount;
